...
describe('Header', () => {
  it('renders the images of the component', () => {
    render(
      <MemoryRouter>
        <DetailHeader pokemon={pokedetails} handleNavigate={handleNavigate} />
      </MemoryRouter>
    );
  ...
  it('checks the name and number of the pokemon', () => {
    ...
    expect(infoContainerElements).toHaveTextContent(pokedetails.name);
    expect(infoContainerElements).toHaveTextContent('#1');
    expect(infoContainerElements).toHaveTextContent(`${pokedetails.id}`);
  });
